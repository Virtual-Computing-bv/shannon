...
import { decryptedAnthropicKey, decryptedGithubToken, getModel } from './settings.js';
  ...
  try {
    ...
    const child = execa('node', args, {
      ...
      env: {
        ...
        // Deep-reasoning (LARGE) tier model chosen in Settings. The worker's
        // resolveModel() reads ANTHROPIC_LARGE_MODEL; small/medium keep defaults.
        ANTHROPIC_LARGE_MODEL: getModel(),
        TEMPORAL_ADDRESS,
